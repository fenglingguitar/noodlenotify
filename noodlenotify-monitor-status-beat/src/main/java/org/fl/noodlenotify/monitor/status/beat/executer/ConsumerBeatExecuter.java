...
public class ConsumerBeatExecuter extends AbstractExecuter {

	private final static Logger logger = LoggerFactory.getLogger(ConsumerBeatExecuter.class);
	...
	public void execute() throws Exception {
		...
		try {
			consoleRemotingInvoke.saveConsumerBeat(consumerModuleRegister.getModuleId());
		} catch (Exception e) {
