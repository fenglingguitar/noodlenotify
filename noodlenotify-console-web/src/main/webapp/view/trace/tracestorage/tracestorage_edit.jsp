    ...
    <script type="text/javascript">
		...
		function save() {
			...
			if (initModel == 'INSERT') {
				...
				transaction({
					id: 'INSERT',
					url: '<%=request.getContextPath()%>/trace/tracestorage/insert',
					jsonSet: jsonSet
				});
			} else {
				...
				transaction({
					id: 'UPDATE',
					url: '<%=request.getContextPath()%>/trace/tracestorage/update',
					jsonSet: jsonSet
				});				
			}
		}
  ...
  <body onload="init();" onkeydown="onEnterDown(save);" >
	...
	<div>
		<div id="form" style="width: auto;">
			<input type="hidden" id="traceStorage_Id"/>
			...
			<table width="100%" border="1" cellspacing="0" cellpadding="0" class="s_layout_input">
			    ...
			    <tr>
			    	<th><label id="name_Label">跟踪数据库名称</label></th>
