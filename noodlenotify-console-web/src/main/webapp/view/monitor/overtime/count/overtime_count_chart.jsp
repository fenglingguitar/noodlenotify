  ...
  <head>
    ...
    <script type="text/javascript">
		...
		function callback(trnId, data, other) {
			...
			if (trnId == "CHART_QUERY") {
				...
				for (i=0; i<data.length; i++) {
					...
					errorSeriesData.push([data[i].timestamp, data[i].overtimeCount]);
				}
		...
		function fullscreen() {
			...
			openChildWindowPost(
					'<%=request.getContextPath()%>/view/monitor/overtime/count/overtime_count_chart_fullscreen.jsp', 
					'urlParam',
			...
			<div id="filterDiv" style="width:97%;">
				<div id="expander-left" class="s_expander">
	        		...
	        		<div id="form" style="width: auto;">
						<table id="filterTable" width="100%" border="1" cellspacing="0" cellpadding="0" class="s_layout">
							<colgroup>
								<col width="40%" />
								<col width="60%" />
							</colgroup>					
