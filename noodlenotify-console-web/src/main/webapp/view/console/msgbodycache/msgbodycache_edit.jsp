    ...
    <script type="text/javascript">
		...
		function save() {
			...
			if (initModel == 'INSERT') {	
				...
				transaction({
					id: 'INSERT',
					url: '<%=request.getContextPath()%>/console/msgbodycache/insert',
					jsonSet: jsonSet
				});
			} else {
				...
				transaction({
					id: 'UPDATE',
					url: '<%=request.getContextPath()%>/console/msgbodycache/update',
					jsonSet: jsonSet
				});				
			}
		}
  ...
  <body onload="init();" onkeydown="onEnterDown(save);" >
	...
	<div>
		<div id="form" style="width: auto;">
			<input type="hidden" id="msgBodyCache_Id"/>
			...
			<table width="100%" border="1" cellspacing="0" cellpadding="0" class="s_layout_input">
			    ...
			    <tr>
			    	<th><label id="name_Label">消息体缓存名称</label></th>
