  ...
  <head>
    ...
    <script type="text/javascript">
		...
		function init() {
			...
			var paramObject = {'customerGroup_Nm': urlParamObject.customerGroup_Nm};
			...
			$('#list_left').jqGrid({
		   		url: '<%=request.getContextPath()%>/console/customergroup/queryincludepage',
				datatype: 'json',
				mtype: 'post',
			...
			$('#list_right').jqGrid({
		   		url: '<%=request.getContextPath()%>/console/customergroup/queryexcludepage',
				datatype: 'json',
				mtype: 'post',
				postData:{'input': jsonToString(paramObject)}, 
			   	colNames: [
		...
		function inserts() {
			...
			for (var i=0; i<indexArray.length; i++) {				
				...
				ret['customerGroup_Nm'] = $('#customerGroup_Nm').val();
				retArray.push(ret);
			}
			...
			transaction({
				id: 'INSERTS',
				url: '<%=request.getContextPath()%>/console/customer/updates',
				jsonSet: jsonSet
			});	
		}
		...
		function deletes() {
			...
			transaction({
				id: 'DELETES',
				url: '<%=request.getContextPath()%>/console/customer/deletesgroup',
				jsonSet: jsonSet
			});
		}
						...
						<div id="form_left" style="width: auto;">
							<table width="100%" border="1" cellspacing="0" cellpadding="0" class="s_layout">
							    ...
							    <tr>
							    	...
							    	<td><input type="text" id="customerGroup_Nm" maxlength="32" disabled="true"/></td>
